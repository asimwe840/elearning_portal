    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher'), ('manager', 'Course Manager'), ('admin', 'Administrator')], default='student', max_length=20)),
                ...
                ('idnumber', models.CharField(blank=True, help_text='Institutional ID number', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aim', models.CharField(blank=True, max_length=50)),
                ('msn', models.CharField(blank=True, max_length=50)),
                ('yahoo', models.CharField(blank=True, max_length=50)),
